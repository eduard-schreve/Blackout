...
image = pygame.image.load("inventory.png")  # Load the inventory image
...
pygame.image.save(imsurf, "inventory_transparent.png")  # Save the new surface as a transparent image